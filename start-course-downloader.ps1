...
$downloaderScript = Join-Path $projectRoot "telegram_media_downloader\auto_course_downloader.py"
...
try {
    ...
    Write-Host "🚀 Khởi động Telegram Auto Course Stream Downloader..." -ForegroundColor Cyan
